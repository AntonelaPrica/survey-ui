...
function useDarkMode() {
    var _a = __read(react_1["default"].useState(Tool_1.store().current === 'dark'), 2), isDark = _a[0], setDark = _a[1];
    react_1["default"].useEffect(function () {
        var chan = addons_1["default"].getChannel();
        chan.on(constants_1.DARK_MODE_EVENT_NAME, setDark);
        return function () { return chan.off(constants_1.DARK_MODE_EVENT_NAME, setDark); };
    }, []);
    return isDark;
}
